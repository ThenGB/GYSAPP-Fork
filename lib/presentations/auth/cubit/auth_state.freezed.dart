...
extension AuthStatePatterns on AuthState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? idToken, bool isLoading, int progress)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AuthState() when $default != null:
        return $default(_that.idToken, _that.isLoading, _that.progress);
      case _:
        return orElse();
    }
  }
...
class _AuthState extends AuthState {
  const _AuthState({this.idToken, this.isLoading = false, this.progress = 0})
      : super._();
