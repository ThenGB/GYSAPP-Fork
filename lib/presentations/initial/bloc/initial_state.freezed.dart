...
mixin _$InitialState {
 ...
 bool get isLoading; bool get isLoaded; bool get isFailed; String get message; bool get isFreshInstall; String get themeMode; int get configFetchTimeoutSeconds; int get configFetchIntervalSeconds; double get defaultTextScale; String get defaultFont;
...
@useResult
$Res call({
 bool isLoading, bool isLoaded, bool isFailed, String message, bool isFreshInstall, String themeMode, int configFetchTimeoutSeconds, int configFetchIntervalSeconds, double defaultTextScale, String defaultFont
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isLoading,  bool isLoaded,  bool isFailed,  String message,  bool isFreshInstall,  String themeMode,  int configFetchTimeoutSeconds,  int configFetchIntervalSeconds,  double defaultTextScale,  String defaultFont)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _InitialState() when $default != null:
return $default(_that.isLoading,_that.isLoaded,_that.isFailed,_that.message,_that.isFreshInstall,_that.themeMode,_that.configFetchTimeoutSeconds,_that.configFetchIntervalSeconds,_that.defaultTextScale,_that.defaultFont);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isLoading,  bool isLoaded,  bool isFailed,  String message,  bool isFreshInstall,  String themeMode,  int configFetchTimeoutSeconds,  int configFetchIntervalSeconds,  double defaultTextScale,  String defaultFont)  $default,) {final _that = this;
switch (_that) {
case _InitialState():
return $default(_that.isLoading,_that.isLoaded,_that.isFailed,_that.message,_that.isFreshInstall,_that.themeMode,_that.configFetchTimeoutSeconds,_that.configFetchIntervalSeconds,_that.defaultTextScale,_that.defaultFont);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isLoading,  bool isLoaded,  bool isFailed,  String message,  bool isFreshInstall,  String themeMode,  int configFetchTimeoutSeconds,  int configFetchIntervalSeconds,  double defaultTextScale,  String defaultFont)?  $default,) {final _that = this;
switch (_that) {
case _InitialState() when $default != null:
return $default(_that.isLoading,_that.isLoaded,_that.isFailed,_that.message,_that.isFreshInstall,_that.themeMode,_that.configFetchTimeoutSeconds,_that.configFetchIntervalSeconds,_that.defaultTextScale,_that.defaultFont);case _:
  return null;
...
class _InitialState extends InitialState {
  const _InitialState({this.isLoading = false, this.isLoaded = false, this.isFailed = false, this.message = '', this.isFreshInstall = true, this.themeMode = 'light', this.configFetchTimeoutSeconds = 5, this.configFetchIntervalSeconds = 10, this.defaultTextScale = 1.2, this.defaultFont = 'Roboto'}): super._();
