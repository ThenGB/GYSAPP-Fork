...
mixin _$FaithState {
  ...
  $FaithStateCopyWith<FaithState> get copyWith =>
      _$FaithStateCopyWithImpl<FaithState>(this as FaithState, _$identity);
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.selectedFaith, selectedFaith) &&
            const DeepCollectionEquality().equals(other.notes, notes) &&
            const DeepCollectionEquality()
                .equals(other.pdfLoadingList, pdfLoadingList) &&
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(selectedFaith),
      const DeepCollectionEquality().hash(notes),
      const DeepCollectionEquality().hash(pdfLoadingList),
      sortNotesBy,
      language,
      defaultFont,
      defaultTextScale,
...
abstract mixin class $FaithStateCopyWith<$Res> {
  factory $FaithStateCopyWith(
          FaithState value, $Res Function(FaithState) _then) =
      _$FaithStateCopyWithImpl;
  @useResult
  $Res call(
...
/// @nodoc
class _$FaithStateCopyWithImpl<$Res> implements $FaithStateCopyWith<$Res> {
...
extension FaithStatePatterns on FaithState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FaithState value)? $default, {
...
class _FaithState extends FaithState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FaithStateCopyWith<_FaithState> get copyWith =>
      __$FaithStateCopyWithImpl<_FaithState>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FaithStateToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$FaithStateCopyWith<$Res>
    implements $FaithStateCopyWith<$Res> {
  factory _$FaithStateCopyWith(
          _FaithState value, $Res Function(_FaithState) _then) =
      __$FaithStateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {List<int> selectedFaith,
...
/// @nodoc
class __$FaithStateCopyWithImpl<$Res> implements _$FaithStateCopyWith<$Res> {
