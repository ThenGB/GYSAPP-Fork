...
mixin _$LiteraturePanduanState {
  ...
  $LiteraturePanduanStateCopyWith<LiteraturePanduanState> get copyWith =>
      _$LiteraturePanduanStateCopyWithImpl<LiteraturePanduanState>(
          this as LiteraturePanduanState, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is LiteraturePanduanState &&
...
abstract mixin class $LiteraturePanduanStateCopyWith<$Res> {
  factory $LiteraturePanduanStateCopyWith(LiteraturePanduanState value,
          $Res Function(LiteraturePanduanState) _then) =
      _$LiteraturePanduanStateCopyWithImpl;
  @useResult
...
extension LiteraturePanduanStatePatterns on LiteraturePanduanState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_LiteraturePanduanState value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool isLoading, List<Panduan> items)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _LiteraturePanduanState extends LiteraturePanduanState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$LiteraturePanduanStateCopyWith<_LiteraturePanduanState> get copyWith =>
      __$LiteraturePanduanStateCopyWithImpl<_LiteraturePanduanState>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$LiteraturePanduanStateToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _LiteraturePanduanState &&
            (identical(other.isLoading, isLoading) ||
                other.isLoading == isLoading) &&
...
/// @nodoc
abstract mixin class _$LiteraturePanduanStateCopyWith<$Res>
    implements $LiteraturePanduanStateCopyWith<$Res> {
  factory _$LiteraturePanduanStateCopyWith(_LiteraturePanduanState value,
          $Res Function(_LiteraturePanduanState) _then) =
      __$LiteraturePanduanStateCopyWithImpl;
  @override
  @useResult
  $Res call({bool isLoading, List<Panduan> items});
}
