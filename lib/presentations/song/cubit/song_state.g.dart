...
_SongState _$SongStateFromJson(Map<String, dynamic> json) => _SongState(
  ...
  midiPreloadEnabled: json['midiPreloadEnabled'] as bool? ?? true,
  midiPreloadNeighborCount:
      (json['midiPreloadNeighborCount'] as num?)?.toInt() ?? 1,
  midiCacheMaxCount: (json['midiCacheMaxCount'] as num?)?.toInt() ?? 12,
  ...
  chordFontSizePercent: (json['chordFontSizePercent'] as num?)?.toInt() ?? 100,
...
Map<String, dynamic> _$SongStateToJson(
  ...
  'remoteLyricsUpdateAt': instance.remoteLyricsUpdateAt.map(
  ...
  'midiPreloadEnabled': instance.midiPreloadEnabled,
  'midiPreloadNeighborCount': instance.midiPreloadNeighborCount,
  'midiCacheMaxCount': instance.midiCacheMaxCount,
