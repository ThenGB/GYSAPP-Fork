...
mixin _$SongState {
 ...
 bool get preferNaturalChords; String? get originalFamilyChord; String? get originalPdfKey; int get baseTransposeOffset; double get tempoBpm; double get defaultTempoBpm; int? get midiInstrument; String get soundFont; bool get midiPreloadEnabled; int get midiPreloadNeighborCount; int get midiCacheMaxCount; bool get isAudioPlaying; bool get pdfTwoPageMode; bool get pdfVerticalScrolling; String get lyricsTextAlign; String get lyricsVerticalAlign; int get chordFontSizePercent; int get chordFillOpacityPercent; int get chordPaddingPercent; Map<int, List<ChordData>> get currentChords;
