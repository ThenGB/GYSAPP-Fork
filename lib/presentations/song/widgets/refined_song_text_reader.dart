...
class _RefinedSongTextReaderState extends State<RefinedSongTextReader> {
  ...
  Song? _currentSong(SongState state) {
    ...
    final index = state.pageIndex.clamp(0, state.songs.length - 1).toInt();
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<SongCubit, SongState>(
      builder: (context, state) {
        ...
        final verseIndex = _verseIndex.clamp(0, verses.length - 1).toInt();
  ...
  int _characterOffsetFor(
    ...
    return painter
        .getPositionForOffset(
          Offset(position.clamp(0.0, 1.0).toDouble() * painter.width, 0),
        )
        .offset
            ...
            child: Column(
              ...
              children: [
                ...
                _SliderSetting(
                  ...
                  value: state.defaultTextScale.clamp(0.8, 1.8).toDouble(),
                  min: 0.8,
                  max: 1.8,
                ...
                _SliderSetting(
                  ...
                  value: state.defaultTextHeight.clamp(1.1, 2.0).toDouble(),
                  min: 1.1,
                  max: 2.0,
