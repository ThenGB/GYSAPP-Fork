...
mixin _$BibleState {
 ...
 String get currentBibleCode; String get splitBibleCode; List<String> get bibleCodes; Verse? get currentBible; Verse? get prevBible; Verse? get currentBibleSplit; Verse? get prevBibleSplit; List<BibleBook> get books; List<BibleBook> get booksSplit; List<Verse> get verses; List<Verse> get versesSplit; List<BibleBookmark> get bookmarks; List<BibleRef> get references; List<BibleRef> get referencesSplit; Map<DateTime, Verse> get histories; List<Pericope> get pericopes; List<Pericope> get pericopesSplit; List<BibleNote> get notes; List<PericopeParalel> get pericopesParalels; List<PericopeParalel> get pericopesParalelsSplit; BibleBook? get currentBook; BibleBook? get currentBookSplit; List<Verse> get selectedVerse; List<Verse> get hightlightedVerse; Verse? get todayReading; DateTime? get lastOpenBible; String get defaultFont; double get defaultTextScale; double get defaultTextHeight; bool get followGlobalFontSettings; String get sortNotesBy; bool get enableAudio; bool get isSpeaking; String get currentWord; int get currentStartWord; int get currentEndWord; List<BibleBook> get selectedFilterBooks; Map<String, Map> get voices; double get speedRate; double get pitchRate;
...
@useResult
$Res call({
 String currentBibleCode, String splitBibleCode, List<String> bibleCodes, Verse? currentBible, Verse? prevBible, Verse? currentBibleSplit, Verse? prevBibleSplit, List<BibleBook> books, List<BibleBook> booksSplit, List<Verse> verses, List<Verse> versesSplit, List<BibleBookmark> bookmarks, List<BibleRef> references, List<BibleRef> referencesSplit, Map<DateTime, Verse> histories, List<Pericope> pericopes, List<Pericope> pericopesSplit, List<BibleNote> notes, List<PericopeParalel> pericopesParalels, List<PericopeParalel> pericopesParalelsSplit, BibleBook? currentBook, BibleBook? currentBookSplit, List<Verse> selectedVerse, List<Verse> hightlightedVerse, Verse? todayReading, DateTime? lastOpenBible, String defaultFont, double defaultTextScale, double defaultTextHeight, bool followGlobalFontSettings, String sortNotesBy, bool enableAudio, bool isSpeaking, String currentWord, int currentStartWord, int currentEndWord, List<BibleBook> selectedFilterBooks, Map<String, Map> voices, double speedRate, double pitchRate
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String currentBibleCode,  String splitBibleCode,  List<String> bibleCodes,  Verse? currentBible,  Verse? prevBible,  Verse? currentBibleSplit,  Verse? prevBibleSplit,  List<BibleBook> books,  List<BibleBook> booksSplit,  List<Verse> verses,  List<Verse> versesSplit,  List<BibleBookmark> bookmarks,  List<BibleRef> references,  List<BibleRef> referencesSplit,  Map<DateTime, Verse> histories,  List<Pericope> pericopes,  List<Pericope> pericopesSplit,  List<BibleNote> notes,  List<PericopeParalel> pericopesParalels,  List<PericopeParalel> pericopesParalelsSplit,  BibleBook? currentBook,  BibleBook? currentBookSplit,  List<Verse> selectedVerse,  List<Verse> hightlightedVerse,  Verse? todayReading,  DateTime? lastOpenBible,  String defaultFont,  double defaultTextScale,  double defaultTextHeight,  bool followGlobalFontSettings,  String sortNotesBy,  bool enableAudio,  bool isSpeaking,  String currentWord,  int currentStartWord,  int currentEndWord,  List<BibleBook> selectedFilterBooks,  Map<String, Map> voices,  double speedRate,  double pitchRate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BibleState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String currentBibleCode,  String splitBibleCode,  List<String> bibleCodes,  Verse? currentBible,  Verse? prevBible,  Verse? currentBibleSplit,  Verse? prevBibleSplit,  List<BibleBook> books,  List<BibleBook> booksSplit,  List<Verse> verses,  List<Verse> versesSplit,  List<BibleBookmark> bookmarks,  List<BibleRef> references,  List<BibleRef> referencesSplit,  Map<DateTime, Verse> histories,  List<Pericope> pericopes,  List<Pericope> pericopesSplit,  List<BibleNote> notes,  List<PericopeParalel> pericopesParalels,  List<PericopeParalel> pericopesParalelsSplit,  BibleBook? currentBook,  BibleBook? currentBookSplit,  List<Verse> selectedVerse,  List<Verse> hightlightedVerse,  Verse? todayReading,  DateTime? lastOpenBible,  String defaultFont,  double defaultTextScale,  double defaultTextHeight,  bool followGlobalFontSettings,  String sortNotesBy,  bool enableAudio,  bool isSpeaking,  String currentWord,  int currentStartWord,  int currentEndWord,  List<BibleBook> selectedFilterBooks,  Map<String, Map> voices,  double speedRate,  double pitchRate)  $default,) {final _that = this;
switch (_that) {
case _BibleState():
return $default(_that.currentBibleCode,_that.splitBibleCode,_that.bibleCodes,_that.currentBible,_that.prevBible,_that.currentBibleSplit,_that.prevBibleSplit,_that.books,_that.booksSplit,_that.verses,_that.versesSplit,_that.bookmarks,_that.references,_that.referencesSplit,_that.histories,_that.pericopes,_that.pericopesSplit,_that.notes,_that.pericopesParalels,_that.pericopesParalelsSplit,_that.currentBook,_that.currentBookSplit,_that.selectedVerse,_that.hightlightedVerse,_that.todayReading,_that.lastOpenBible,_that.defaultFont,_that.defaultTextScale,_that.defaultTextHeight,_that.followGlobalFontSettings,_that.sortNotesBy,_that.enableAudio,_that.isSpeaking,_that.currentWord,_that.currentStartWord,_that.currentEndWord,_that.selectedFilterBooks,_that.voices,_that.speedRate,_that.pitchRate);case _:
  throw StateError('Unexpected subclass');
