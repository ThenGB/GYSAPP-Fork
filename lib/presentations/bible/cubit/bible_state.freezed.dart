...
mixin _$BibleState {
 ...
 String get currentBibleCode; String get splitBibleCode; List<String> get bibleCodes; Verse? get currentBible; Verse? get prevBible; Verse? get currentBibleSplit; Verse? get prevBibleSplit; List<BibleBook> get books; List<BibleBook> get booksSplit; List<Verse> get verses; List<BibleBookmark> get bookmarks; List<BibleRef> get references; List<BibleRef> get referencesSplit; List<Verse> get versesSplit; Map<DateTime, Verse> get histories; List<Pericope> get pericopes; List<Pericope> get pericopesSplit; List<BibleNote> get notes; List<PericopeParalel> get pericopesParalels; List<PericopeParalel> get pericopesParalelsSplit; BibleBook? get currentBook; BibleBook? get currentBookSplit; List<Verse> get selectedVerse; List<Verse> get hightlightedVerse; Verse? get todayReading; DateTime? get lastOpenBible; String get defaultFont; double get defaultTextScale; double get defaultTextHeight; String get sortNotesBy; bool get enableAudio; bool get isSpeaking; String get currentWord; int get currentStartWord; int get currentEndWord; List<BibleBook> get selectedFilterBooks; Map<String, Map> get voices; double get speedRate; double get pitchRate;
...
@useResult
$Res call({
 String currentBibleCode, String splitBibleCode, List<String> bibleCodes, Verse? currentBible, Verse? prevBible, Verse? currentBibleSplit, Verse? prevBibleSplit, List<BibleBook> books, List<BibleBook> booksSplit, List<Verse> verses, List<BibleBookmark> bookmarks, List<BibleRef> references, List<BibleRef> referencesSplit, List<Verse> versesSplit, Map<DateTime, Verse> histories, List<Pericope> pericopes, List<Pericope> pericopesSplit, List<BibleNote> notes, List<PericopeParalel> pericopesParalels, List<PericopeParalel> pericopesParalelsSplit, BibleBook? currentBook, BibleBook? currentBookSplit, List<Verse> selectedVerse, List<Verse> hightlightedVerse, Verse? todayReading, DateTime? lastOpenBible, String defaultFont, double defaultTextScale, double defaultTextHeight, String sortNotesBy, bool enableAudio, bool isSpeaking, String currentWord, int currentStartWord, int currentEndWord, List<BibleBook> selectedFilterBooks, Map<String, Map> voices, double speedRate, double pitchRate
});
...
/// Create a copy of BibleState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? currentBibleCode = null,Object? splitBibleCode = null,Object? bibleCodes = null,Object? currentBible = freezed,Object? prevBible = freezed,Object? currentBibleSplit = freezed,Object? prevBibleSplit = freezed,Object? books = null,Object? booksSplit = null,Object? verses = null,Object? bookmarks = null,Object? references = null,Object? referencesSplit = null,Object? versesSplit = null,Object? histories = null,Object? pericopes = null,Object? pericopesSplit = null,Object? notes = null,Object? pericopesParalels = null,Object? pericopesParalelsSplit = null,Object? currentBook = freezed,Object? currentBookSplit = freezed,Object? selectedVerse = null,Object? hightlightedVerse = null,Object? todayReading = freezed,Object? lastOpenBible = freezed,Object? defaultFont = null,Object? defaultTextScale = null,Object? defaultTextHeight = null,Object? sortNotesBy = null,Object? enableAudio = null,Object? isSpeaking = null,Object? currentWord = null,Object? currentStartWord = null,Object? currentEndWord = null,Object? selectedFilterBooks = null,Object? voices = null,Object? speedRate = null,Object? pitchRate = null,}) {
...
as List<BibleRef>,versesSplit: null == versesSplit ? _self.versesSplit : versesSplit // ignore: cast_nullable_to_non_nullable
as List<Verse>,histories: null == histories ? _self.histories : histories // ignore: cast_nullable_to_non_nullable
...
as double,sortNotesBy: null == sortNotesBy ? _self.sortNotesBy : sortNotesBy // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String currentBibleCode,  String splitBibleCode,  List<String> bibleCodes,  Verse? currentBible,  Verse? prevBible,  Verse? currentBibleSplit,  Verse? prevBibleSplit,  List<BibleBook> books,  List<BibleBook> booksSplit,  List<Verse> verses,  List<BibleBookmark> bookmarks,  List<BibleRef> references,  List<BibleRef> referencesSplit,  List<Verse> versesSplit,  Map<DateTime, Verse> histories,  List<Pericope> pericopes,  List<Pericope> pericopesSplit,  List<BibleNote> notes,  List<PericopeParalel> pericopesParalels,  List<PericopeParalel> pericopesParalelsSplit,  BibleBook? currentBook,  BibleBook? currentBookSplit,  List<Verse> selectedVerse,  List<Verse> hightlightedVerse,  Verse? todayReading,  DateTime? lastOpenBible,  String defaultFont,  double defaultTextScale,  double defaultTextHeight,  String sortNotesBy,  bool enableAudio,  bool isSpeaking,  String currentWord,  int currentStartWord,  int currentEndWord,  List<BibleBook> selectedFilterBooks,  Map<String, Map> voices,  double speedRate,  double pitchRate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BibleState() when $default != null:
return $default(_that.currentBibleCode,_that.splitBibleCode,_that.bibleCodes,_that.currentBible,_that.prevBible,_that.currentBibleSplit,_that.prevBibleSplit,_that.books,_that.booksSplit,_that.verses,_that.bookmarks,_that.references,_that.referencesSplit,_that.versesSplit,_that.histories,_that.pericopes,_that.pericopesSplit,_that.notes,_that.pericopesParalels,_that.pericopesParalelsSplit,_that.currentBook,_that.currentBookSplit,_that.selectedVerse,_that.hightlightedVerse,_that.todayReading,_that.lastOpenBible,_that.defaultFont,_that.defaultTextScale,_that.defaultTextHeight,_that.sortNotesBy,_that.enableAudio,_that.isSpeaking,_that.currentWord,_that.currentStartWord,_that.currentEndWord,_that.selectedFilterBooks,_that.voices,_that.speedRate,_that.pitchRate);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String currentBibleCode,  String splitBibleCode,  List<String> bibleCodes,  Verse? currentBible,  Verse? prevBible,  Verse? currentBibleSplit,  Verse? prevBibleSplit,  List<BibleBook> books,  List<BibleBook> booksSplit,  List<Verse> verses,  List<BibleBookmark> bookmarks,  List<BibleRef> references,  List<BibleRef> referencesSplit,  List<Verse> versesSplit,  Map<DateTime, Verse> histories,  List<Pericope> pericopes,  List<Pericope> pericopesSplit,  List<BibleNote> notes,  List<PericopeParalel> pericopesParalels,  List<PericopeParalel> pericopesParalelsSplit,  BibleBook? currentBook,  BibleBook? currentBookSplit,  List<Verse> selectedVerse,  List<Verse> hightlightedVerse,  Verse? todayReading,  DateTime? lastOpenBible,  String defaultFont,  double defaultTextScale,  double defaultTextHeight,  String sortNotesBy,  bool enableAudio,  bool isSpeaking,  String currentWord,  int currentStartWord,  int currentEndWord,  List<BibleBook> selectedFilterBooks,  Map<String, Map> voices,  double speedRate,  double pitchRate)  $default,) {final _that = this;
switch (_that) {
case _BibleState():
return $default(_that.currentBibleCode,_that.splitBibleCode,_that.bibleCodes,_that.currentBible,_that.prevBible,_that.currentBibleSplit,_that.prevBibleSplit,_that.books,_that.booksSplit,_that.verses,_that.bookmarks,_that.references,_that.referencesSplit,_that.versesSplit,_that.histories,_that.pericopes,_that.pericopesSplit,_that.notes,_that.pericopesParalels,_that.pericopesParalelsSplit,_that.currentBook,_that.currentBookSplit,_that.selectedVerse,_that.hightlightedVerse,_that.todayReading,_that.lastOpenBible,_that.defaultFont,_that.defaultTextScale,_that.defaultTextHeight,_that.sortNotesBy,_that.enableAudio,_that.isSpeaking,_that.currentWord,_that.currentStartWord,_that.currentEndWord,_that.selectedFilterBooks,_that.voices,_that.speedRate,_that.pitchRate);case _:
  throw StateError('Unexpected subclass');
...
class _BibleState extends BibleState {
  const _BibleState({this.currentBibleCode = 'b_tb', this.splitBibleCode = 'b_tb', final  List<String> bibleCodes = const [], this.currentBible, this.prevBible, this.currentBibleSplit, this.prevBibleSplit, final  List<BibleBook> books = const [], final  List<BibleBook> booksSplit = const [], final  List<Verse> verses = const [], final  List<BibleBookmark> bookmarks = const [], final  List<BibleRef> references = const [], final  List<BibleRef> referencesSplit = const [], final  List<Verse> versesSplit = const [], final  Map<DateTime, Verse> histories = const {}, final  List<Pericope> pericopes = const [], final  List<Pericope> pericopesSplit = const [], final  List<BibleNote> notes = const [], final  List<PericopeParalel> pericopesParalels = const [], final  List<PericopeParalel> pericopesParalelsSplit = const [], this.currentBook, this.currentBookSplit, final  List<Verse> selectedVerse = const [], final  List<Verse> hightlightedVerse = const [], this.todayReading, this.lastOpenBible, this.defaultFont = 'Roboto', this.defaultTextScale = 1.2, this.defaultTextHeight = 1.5, this.sortNotesBy = 'Newest', this.enableAudio = false, this.isSpeaking = false, this.currentWord = '', this.currentStartWord = 0, this.currentEndWord = 0, final  List<BibleBook> selectedFilterBooks = const [], final  Map<String, Map> voices = const {}, this.speedRate = .35, this.pitchRate = .90}): _bibleCodes = bibleCodes,_books = books,_booksSplit = booksSplit,_verses = verses,_bookmarks = bookmarks,_references = references,_referencesSplit = referencesSplit,_versesSplit = versesSplit,_histories = histories,_pericopes = pericopes,_pericopesSplit = pericopesSplit,_notes = notes,_pericopesParalels = pericopesParalels,_pericopesParalelsSplit = pericopesParalelsSplit,_selectedVerse = selectedVerse,_hightlightedVerse = hightlightedVerse,_selectedFilterBooks = selectedFilterBooks,_voices = voices,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BibleState&&(identical(other.currentBibleCode, currentBibleCode) || other.currentBibleCode == currentBibleCode)&&(identical(other.splitBibleCode, splitBibleCode) || other.splitBibleCode == splitBibleCode)&&const DeepCollectionEquality().equals(other._bibleCodes, _bibleCodes)&&(identical(other.currentBible, currentBible) || other.currentBible == currentBible)&&(identical(other.prevBible, prevBible) || other.prevBible == prevBible)&&(identical(other.currentBibleSplit, currentBibleSplit) || other.currentBibleSplit == currentBibleSplit)&&(identical(other.prevBibleSplit, prevBibleSplit) || other.prevBibleSplit == prevBibleSplit)&&const DeepCollectionEquality().equals(other._books, _books)&&const DeepCollectionEquality().equals(other._booksSplit, _booksSplit)&&const DeepCollectionEquality().equals(other._verses, _verses)&&const DeepCollectionEquality().equals(other._bookmarks, _bookmarks)&&const DeepCollectionEquality().equals(other._references, _references)&&const DeepCollectionEquality().equals(other._referencesSplit, _referencesSplit)&&const DeepCollectionEquality().equals(other._versesSplit, _versesSplit)&&const DeepCollectionEquality().equals(other._histories, _histories)&&const DeepCollectionEquality().equals(other._pericopes, _pericopes)&&const DeepCollectionEquality().equals(other._pericopesSplit, _pericopesSplit)&&const DeepCollectionEquality().equals(other._notes, _notes)&&const DeepCollectionEquality().equals(other._pericopesParalels, _pericopesParalels)&&const DeepCollectionEquality().equals(other._pericopesParalelsSplit, _pericopesParalelsSplit)&&(identical(other.currentBook, currentBook) || other.currentBook == currentBook)&&(identical(other.currentBookSplit, currentBookSplit) || other.currentBookSplit == currentBookSplit)&&const DeepCollectionEquality().equals(other._selectedVerse, _selectedVerse)&&const DeepCollectionEquality().equals(other._hightlightedVerse, _hightlightedVerse)&&(identical(other.todayReading, todayReading) || other.todayReading == todayReading)&&(identical(other.lastOpenBible, lastOpenBible) || other.lastOpenBible == lastOpenBible)&&(identical(other.defaultFont, defaultFont) || other.defaultFont == defaultFont)&&(identical(other.defaultTextScale, defaultTextScale) || other.defaultTextScale == defaultTextScale)&&(identical(other.defaultTextHeight, defaultTextHeight) || other.defaultTextHeight == defaultTextHeight)&&(identical(other.sortNotesBy, sortNotesBy) || other.sortNotesBy == sortNotesBy)&&(identical(other.enableAudio, enableAudio) || other.enableAudio == enableAudio)&&(identical(other.isSpeaking, isSpeaking) || other.isSpeaking == isSpeaking)&&(identical(other.currentWord, currentWord) || other.currentWord == currentWord)&&(identical(other.currentStartWord, currentStartWord) || other.currentStartWord == currentStartWord)&&(identical(other.currentEndWord, currentEndWord) || other.currentEndWord == currentEndWord)&&const DeepCollectionEquality().equals(other._selectedFilterBooks, _selectedFilterBooks)&&const DeepCollectionEquality().equals(other._voices, _voices)&&(identical(other.speedRate, speedRate) || other.speedRate == speedRate)&&(identical(other.pitchRate, pitchRate) || other.pitchRate == pitchRate));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,currentBibleCode,splitBibleCode,const DeepCollectionEquality().hash(_bibleCodes),currentBible,prevBible,currentBibleSplit,prevBibleSplit,const DeepCollectionEquality().hash(_books),const DeepCollectionEquality().hash(_booksSplit),const DeepCollectionEquality().hash(_verses),const DeepCollectionEquality().hash(_bookmarks),const DeepCollectionEquality().hash(_references),const DeepCollectionEquality().hash(_referencesSplit),const DeepCollectionEquality().hash(_versesSplit),const DeepCollectionEquality().hash(_histories),const DeepCollectionEquality().hash(_pericopes),const DeepCollectionEquality().hash(_pericopesSplit),const DeepCollectionEquality().hash(_notes),const DeepCollectionEquality().hash(_pericopesParalels),const DeepCollectionEquality().hash(_pericopesParalelsSplit),currentBook,currentBookSplit,const DeepCollectionEquality().hash(_selectedVerse),const DeepCollectionEquality().hash(_hightlightedVerse),todayReading,lastOpenBible,defaultFont,defaultTextScale,defaultTextHeight,sortNotesBy,enableAudio,isSpeaking,currentWord,currentStartWord,currentEndWord,const DeepCollectionEquality().hash(_selectedFilterBooks),const DeepCollectionEquality().hash(_voices),speedRate,pitchRate]);
...
as List<BibleRef>,versesSplit: null == versesSplit ? _self._versesSplit : versesSplit // ignore: cast_nullable_to_non_nullable
as List<Verse>,histories: null == histories ? _self._histories : histories // ignore: cast_nullable_to_non_nullable
