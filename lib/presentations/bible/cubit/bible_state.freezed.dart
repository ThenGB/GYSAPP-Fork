...
mixin _$BibleState {
 ...
 String get currentBibleCode; String get splitBibleCode; List<String> get bibleCodes; Verse? get currentBible; Verse? get prevBible; Verse? get currentBibleSplit; Verse? get prevBibleSplit; List<BibleBook> get books; List<BibleBook> get booksSplit; List<Verse> get verses; List<Verse> get versesSplit; List<BibleBookmark> get bookmarks; List<BibleRef> get references; List<BibleRef> get referencesSplit; Map<DateTime, Verse> get histories; List<Pericope> get pericopes; List<Pericope> get pericopesSplit; List<BibleNote> get notes; List<PericopeParalel> get pericopesParalels; List<PericopeParalel> get pericopesParalelsSplit; BibleBook? get currentBook; BibleBook? get currentBookSplit; List<Verse> get selectedVerse; List<Verse> get hightlightedVerse; Verse? get todayReading; DateTime? get lastOpenBible; String get defaultFont; double get defaultTextScale; double get defaultTextHeight; bool get followGlobalFontSettings; String get sortNotesBy; bool get enableAudio; bool get isSpeaking; bool get isTtsPaused; String get ttsEngine; String get edgeVoice; String get edgeRate; String get edgePitch; String get edgeVolume; bool get autoNextChapter;/// Start target of TTS playback (book + chapter + verse).  Null = the
/// current reading position.  Set either by the range controls in the
/// audio sidebar or by tapping a verse while audio is open.
 Verse? get ttsPlayRangeStart;/// End target of TTS playback.  Null = play until the END OF THE CURRENT
...
/// expressed by [autoNextChapter] = true.
 Verse? get ttsPlayRangeEnd; int get ttsCurrentVerseIndex; bool get isSpeakingSelectedOnly; bool get isSplitContentLoading; String get currentWord; int get currentStartWord; int get currentEndWord; List<BibleBook> get selectedFilterBooks; Map<String, Map> get voices; double get speedRate; double get pitchRate;
...
@useResult
$Res call({
 String currentBibleCode, String splitBibleCode, List<String> bibleCodes, Verse? currentBible, Verse? prevBible, Verse? currentBibleSplit, Verse? prevBibleSplit, List<BibleBook> books, List<BibleBook> booksSplit, List<Verse> verses, List<Verse> versesSplit, List<BibleBookmark> bookmarks, List<BibleRef> references, List<BibleRef> referencesSplit, Map<DateTime, Verse> histories, List<Pericope> pericopes, List<Pericope> pericopesSplit, List<BibleNote> notes, List<PericopeParalel> pericopesParalels, List<PericopeParalel> pericopesParalelsSplit, BibleBook? currentBook, BibleBook? currentBookSplit, List<Verse> selectedVerse, List<Verse> hightlightedVerse, Verse? todayReading, DateTime? lastOpenBible, String defaultFont, double defaultTextScale, double defaultTextHeight, bool followGlobalFontSettings, String sortNotesBy, bool enableAudio, bool isSpeaking, bool isTtsPaused, String ttsEngine, String edgeVoice, String edgeRate, String edgePitch, String edgeVolume, bool autoNextChapter, Verse? ttsPlayRangeStart, Verse? ttsPlayRangeEnd, int ttsCurrentVerseIndex, bool isSpeakingSelectedOnly, bool isSplitContentLoading, String currentWord, int currentStartWord, int currentEndWord, List<BibleBook> selectedFilterBooks, Map<String, Map> voices, double speedRate, double pitchRate
});


$VerseCopyWith<$Res>? get currentBible;$VerseCopyWith<$Res>? get prevBible;$VerseCopyWith<$Res>? get currentBibleSplit;$VerseCopyWith<$Res>? get prevBibleSplit;$BibleBookCopyWith<$Res>? get currentBook;$BibleBookCopyWith<$Res>? get currentBookSplit;$VerseCopyWith<$Res>? get todayReading;$VerseCopyWith<$Res>? get ttsPlayRangeStart;$VerseCopyWith<$Res>? get ttsPlayRangeEnd;
...
as bool,isTtsPaused: null == isTtsPaused ? _self.isTtsPaused : isTtsPaused // ignore: cast_nullable_to_non_nullable
as bool,ttsEngine: null == ttsEngine ? _self.ttsEngine : ttsEngine // ignore: cast_nullable_to_non_nullable
as String,edgeVoice: null == edgeVoice ? _self.edgeVoice : edgeVoice // ignore: cast_nullable_to_non_nullable
as String,edgeRate: null == edgeRate ? _self.edgeRate : edgeRate // ignore: cast_nullable_to_non_nullable
as String,edgePitch: null == edgePitch ? _self.edgePitch : edgePitch // ignore: cast_nullable_to_non_nullable
as String,edgeVolume: null == edgeVolume ? _self.edgeVolume : edgeVolume // ignore: cast_nullable_to_non_nullable
as String,autoNextChapter: null == autoNextChapter ? _self.autoNextChapter : autoNextChapter // ignore: cast_nullable_to_non_nullable
as bool,ttsPlayRangeStart: freezed == ttsPlayRangeStart ? _self.ttsPlayRangeStart : ttsPlayRangeStart // ignore: cast_nullable_to_non_nullable
as Verse?,ttsPlayRangeEnd: freezed == ttsPlayRangeEnd ? _self.ttsPlayRangeEnd : ttsPlayRangeEnd // ignore: cast_nullable_to_non_nullable
as Verse?,ttsCurrentVerseIndex: null == ttsCurrentVerseIndex ? _self.ttsCurrentVerseIndex : ttsCurrentVerseIndex // ignore: cast_nullable_to_non_nullable
as int,isSpeakingSelectedOnly: null == isSpeakingSelectedOnly ? _self.isSpeakingSelectedOnly : isSpeakingSelectedOnly // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$VerseCopyWith<$Res>? get ttsPlayRangeStart {
    if (_self.ttsPlayRangeStart == null) {
    return null;
  }

  return $VerseCopyWith<$Res>(_self.ttsPlayRangeStart!, (value) {
    return _then(_self.copyWith(ttsPlayRangeStart: value));
  });
}/// Create a copy of BibleState
/// with the given fields replaced by the non-null parameter values.
@override
@pragma('vm:prefer-inline')
$VerseCopyWith<$Res>? get ttsPlayRangeEnd {
    if (_self.ttsPlayRangeEnd == null) {
    return null;
  }

  return $VerseCopyWith<$Res>(_self.ttsPlayRangeEnd!, (value) {
    return _then(_self.copyWith(ttsPlayRangeEnd: value));
  });
}
}
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String currentBibleCode,  String splitBibleCode,  List<String> bibleCodes,  Verse? currentBible,  Verse? prevBible,  Verse? currentBibleSplit,  Verse? prevBibleSplit,  List<BibleBook> books,  List<BibleBook> booksSplit,  List<Verse> verses,  List<Verse> versesSplit,  List<BibleBookmark> bookmarks,  List<BibleRef> references,  List<BibleRef> referencesSplit,  Map<DateTime, Verse> histories,  List<Pericope> pericopes,  List<Pericope> pericopesSplit,  List<BibleNote> notes,  List<PericopeParalel> pericopesParalels,  List<PericopeParalel> pericopesParalelsSplit,  BibleBook? currentBook,  BibleBook? currentBookSplit,  List<Verse> selectedVerse,  List<Verse> hightlightedVerse,  Verse? todayReading,  DateTime? lastOpenBible,  String defaultFont,  double defaultTextScale,  double defaultTextHeight,  bool followGlobalFontSettings,  String sortNotesBy,  bool enableAudio,  bool isSpeaking,  bool isTtsPaused,  String ttsEngine,  String edgeVoice,  String edgeRate,  String edgePitch,  String edgeVolume,  bool autoNextChapter,  Verse? ttsPlayRangeStart,  Verse? ttsPlayRangeEnd,  int ttsCurrentVerseIndex,  bool isSpeakingSelectedOnly,  bool isSplitContentLoading,  String currentWord,  int currentStartWord,  int currentEndWord,  List<BibleBook> selectedFilterBooks,  Map<String, Map> voices,  double speedRate,  double pitchRate)  $default,) {final _that = this;
switch (_that) {
case _BibleState():
return $default(_that.currentBibleCode,_that.splitBibleCode,_that.bibleCodes,_that.currentBible,_that.prevBible,_that.currentBibleSplit,_that.prevBibleSplit,_that.books,_that.booksSplit,_that.verses,_that.versesSplit,_that.bookmarks,_that.references,_that.referencesSplit,_that.histories,_that.pericopes,_that.pericopesSplit,_that.notes,_that.pericopesParalels,_that.pericopesParalelsSplit,_that.currentBook,_that.currentBookSplit,_that.selectedVerse,_that.hightlightedVerse,_that.todayReading,_that.lastOpenBible,_that.defaultFont,_that.defaultTextScale,_that.defaultTextHeight,_that.followGlobalFontSettings,_that.sortNotesBy,_that.enableAudio,_that.isSpeaking,_that.isTtsPaused,_that.ttsEngine,_that.edgeVoice,_that.edgeRate,_that.edgePitch,_that.edgeVolume,_that.autoNextChapter,_that.ttsPlayRangeStart,_that.ttsPlayRangeEnd,_that.ttsCurrentVerseIndex,_that.isSpeakingSelectedOnly,_that.isSplitContentLoading,_that.currentWord,_that.currentStartWord,_that.currentEndWord,_that.selectedFilterBooks,_that.voices,_that.speedRate,_that.pitchRate);case _:
  throw StateError('Unexpected subclass');
...
@override@JsonKey() final  bool isTtsPaused;
@override@JsonKey() final  String ttsEngine;
@override@JsonKey() final  String edgeVoice;
@override@JsonKey() final  String edgeRate;
@override@JsonKey() final  String edgePitch;
@override@JsonKey() final  String edgeVolume;
@override@JsonKey() final  bool autoNextChapter;
/// Start target of TTS playback (book + chapter + verse).  Null = the
/// current reading position.  Set either by the range controls in the
/// audio sidebar or by tapping a verse while audio is open.
@override@JsonKey() final  Verse? ttsPlayRangeStart;
/// End target of TTS playback.  Null = play until the END OF THE CURRENT
/// CHAPTER and stop.  When set, reading stops after this verse.
/// "Lanjut terus" (continuing through the following chapters/books) is
/// expressed by [autoNextChapter] = true.
@override@JsonKey() final  Verse? ttsPlayRangeEnd;
@override@JsonKey() final  int ttsCurrentVerseIndex;
@override@JsonKey() final  bool isSpeakingSelectedOnly;
...
@override $VerseCopyWith<$Res>? get currentBible;@override $VerseCopyWith<$Res>? get prevBible;@override $VerseCopyWith<$Res>? get currentBibleSplit;@override $VerseCopyWith<$Res>? get prevBibleSplit;@override $BibleBookCopyWith<$Res>? get currentBook;@override $BibleBookCopyWith<$Res>? get currentBookSplit;@override $VerseCopyWith<$Res>? get todayReading;@override $VerseCopyWith<$Res>? get ttsPlayRangeStart;@override $VerseCopyWith<$Res>? get ttsPlayRangeEnd;
