...
class BibleListRouteArgs {
  ...
  @override
  String toString() {
    return 'BibleListRouteArgs{key: $key, books: $books, getBibles: $getBibles, onSelected: $onSelected}';
  }
}
...
class BibleNoteListRouteArgs {
  ...
  @override
  String toString() {
    return 'BibleNoteListRouteArgs{key: $key, cubit: $cubit}';
  }
}
