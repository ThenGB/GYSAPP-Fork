...
@JsonKey(name: 'code') String? get code;@JsonKey(name: 'songs') List<Song> get songs;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SongBook&&(identical(other.code, code) || other.code == code)&&const DeepCollectionEquality().equals(other.songs, songs));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,code,const DeepCollectionEquality().hash(songs));
...
@useResult
$Res call({
@JsonKey(name: 'code') String? code,@JsonKey(name: 'songs') List<Song> songs
});
...
/// Create a copy of SongBook
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? code = freezed,Object? songs = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'code')  String? code, @JsonKey(name: 'songs')  List<Song> songs)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SongBook() when $default != null:
return $default(_that.code,_that.songs);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'code')  String? code, @JsonKey(name: 'songs')  List<Song> songs)  $default,) {final _that = this;
switch (_that) {
case _SongBook():
return $default(_that.code,_that.songs);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'code')  String? code, @JsonKey(name: 'songs')  List<Song> songs)?  $default,) {final _that = this;
switch (_that) {
case _SongBook() when $default != null:
return $default(_that.code,_that.songs);case _:
  return null;
...
class _SongBook extends SongBook {
  const _SongBook({@JsonKey(name: 'code') this.code, @JsonKey(name: 'songs') final  List<Song> songs = const []}): _songs = songs,super._();
  factory _SongBook.fromJson(Map<String, dynamic> json) => _$SongBookFromJson(json);

@override@JsonKey(name: 'code') final  String? code;
 final  List<Song> _songs;
@override@JsonKey(name: 'songs') List<Song> get songs {
...
@override
Map<String, dynamic> toJson() {
  return _$SongBookToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SongBook&&(identical(other.code, code) || other.code == code)&&const DeepCollectionEquality().equals(other._songs, _songs));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,code,const DeepCollectionEquality().hash(_songs));
...
/// Create a copy of SongBook
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? code = freezed,Object? songs = null,}) {
...
as String?,soundfilePath: freezed == soundfilePath ? _self.soundfilePath : soundfilePath // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey(name: 'number2') final  String? number2;
@override@JsonKey(name: 'lyric') final  String? title;
@override@JsonKey(name: 'song') final  String? soundfilePath;
@override@JsonKey(name: 'pages') final  int? pageLength;
@override@JsonKey(name: 'page') final  int? pageStart;
 final  List<String> _verses;
@override@JsonKey(name: 'verses') List<String> get verses {
