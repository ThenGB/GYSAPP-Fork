...
$SauhCopyWith<Sauh> get copyWith => _$SauhCopyWithImpl<Sauh>(this as Sauh, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Sauh&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description)&&(identical(other.url, url) || other.url == url)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl));
}
...
abstract mixin class $SauhCopyWith<$Res>  {
  factory $SauhCopyWith(Sauh value, $Res Function(Sauh) _then) = _$SauhCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$SauhCopyWithImpl<$Res>
    implements $SauhCopyWith<$Res> {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Sauh value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Sauh value)  $default,){
final _that = this;
switch (_that) {
case _Sauh():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Sauh value)?  $default,){
final _that = this;
switch (_that) {
case _Sauh() when $default != null:
return $default(_that);case _:
...
class _Sauh extends Sauh {
  const _Sauh({required this.title, required this.description, required this.url, required this.imageUrl}): super._();
...
@pragma('vm:prefer-inline')
_$SauhCopyWith<_Sauh> get copyWith => __$SauhCopyWithImpl<_Sauh>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$SauhToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Sauh&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description)&&(identical(other.url, url) || other.url == url)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl));
}
...
abstract mixin class _$SauhCopyWith<$Res> implements $SauhCopyWith<$Res> {
  factory _$SauhCopyWith(_Sauh value, $Res Function(_Sauh) _then) = __$SauhCopyWithImpl;
@override @useResult
$Res call({
 String title, String description, String url, String imageUrl
});
...
/// @nodoc
class __$SauhCopyWithImpl<$Res>
    implements _$SauhCopyWith<$Res> {
