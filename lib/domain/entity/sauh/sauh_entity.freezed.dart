...
Sauh _$SauhFromJson(Map<String, dynamic> json) {
  return _Sauh.fromJson(json);
}
...
mixin _$Sauh {
  ...
  @JsonKey(ignore: true)
  $SauhCopyWith<Sauh> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SauhCopyWith<$Res> {
  factory $SauhCopyWith(Sauh value, $Res Function(Sauh) then) =
      _$SauhCopyWithImpl<$Res, Sauh>;
  @useResult
  $Res call({String title, String description, String url, String imageUrl});
}

/// @nodoc
class _$SauhCopyWithImpl<$Res, $Val extends Sauh>
    implements $SauhCopyWith<$Res> {
  _$SauhCopyWithImpl(this._value, this._then);
...
abstract class _Sauh extends Sauh {
  const factory _Sauh(
