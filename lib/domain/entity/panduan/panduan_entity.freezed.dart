...
/// @nodoc
abstract class $PanduanCopyWith<$Res> {
  factory $PanduanCopyWith(Panduan value, $Res Function(Panduan) then) =
      _$PanduanCopyWithImpl<$Res, Panduan>;
  @useResult
  $Res call({String title, String description, String url, String imageUrl});
}

/// @nodoc
class _$PanduanCopyWithImpl<$Res, $Val extends Panduan>
    implements $PanduanCopyWith<$Res> {
  _$PanduanCopyWithImpl(this._value, this._then);
...
abstract class _Panduan extends Panduan {
  const factory _Panduan(
