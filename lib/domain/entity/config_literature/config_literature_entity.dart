...
class ConfigLiterature with _$ConfigLiterature {
  ...
  const factory ConfigLiterature({
    ...
    @Default('div.module.module-accordion.tb_9pdq304 > ul > li > div > div > div > table > tbody > tr > td > a')
        String panduanAlkitab,
    @JsonKey(name: 'renungan')
    @Default('div.module.module-accordion.tb_1uum169 > ul > li > div > div > div > table > tbody > tr > td > a')
        String renungan,
