...
class AppConfigStore {
  ...
  static bool _useFallbackConfig = true;
  ...
  static final Map<String, Object> fallbackConfig = {
    ...
    'config_fetch_policy': '{"fetch_timeout":10,"fetch_interval":3600}',
    'sauhconfig': '',
    'enabled_music_code': '',
  };
  ...
  static void _configLog(Object? value, String key, {bool fallback = false}) {
    ...
    final source = fallback ? 'bundled app config' : 'app config';
    log(value.toString(), name: 'Get $key from $source');
  }

  static Future<Map<String, dynamic>> jsonConfig(String key) async {
    try {
      final jsonString = _fallbackString(key);
      Map<String, dynamic> json = jsonDecode(jsonString);
      _configLog(json, key, fallback: _useFallbackConfig);
      return json;
    } catch (e) {
      return {};
    }
  ...
  static Future<String> stringConfig(String key) async {
    ...
    _configLog(jsonString, key, fallback: _useFallbackConfig);
    return jsonString;
  }

  static Future<bool> boolConfig(String key) async {
    var value = _fallbackString(key).toLowerCase() == 'true';
    _configLog(value, key, fallback: _useFallbackConfig);
    return value;
  }
